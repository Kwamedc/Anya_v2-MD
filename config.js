...
module.exports = {
    ...
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 ❌‿❌➳ᴹᴿ᭄ⅅÇ⚔️ ℒøℛⅅ ℬℛëëℤᎽ✧❤乂",
    ...
    ownernumber: process.env.Owner_Number || "233531725160",
    ...
    packname: process.env.PackName || "❌‿❌➳ᴹᴿ᭄ⅅÇ⚔️ ℒøℛⅅ ℬℛëëℤᎽ✧❤乂🪀",
    ...
    sessionId: process.env.SESSION_ID || "qPcshGlSvroN9DY1_A_N_Y_A_V_2_2lhK",
